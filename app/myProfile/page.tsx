  ...
  const dummyReviews = [
    {
      ...
      star: 4.5,
      review:
        "디자인 감각이 뛰어나고 세부적인 디테일까지 꼼꼼하게 챙기는 모습이 인상적입니다. 아이디어 회의 때는 다른 사람의 생각을 잘 경청하며....",
    },
    {
      name: "박서현",
      star: 4.0,
            ...
            <div className="grid grid-cols-3 gap-x-3 gap-y-5">
              {dummyProjects.map((idx, key) => (
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 2%, rgba(0, 0, 0, 0.4) 83%), url(${idx.bgImg}) `,
                  }}
                >
                  <div className="flex flex-col items-end justify p-4">
                    <div
                      ...
                      style={{
                        backgroundColor: CategoryColors[idx.category][1],
                      }}
                    >
                      <div
                  ...
                  <div className="flex flex-col justify-end p-3">
                    <div className="flex text-white gap-x-2">
                      ...
                      <div className="text-[10px]">
                        {idx.endDate.year}년 {idx.endDate.month}월{" "}
                        {idx.endDate.day}일
                      </div>
                    </div>
