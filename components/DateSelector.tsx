...
export default function DateSelector({
  ...
  const inputCls =
    "w-[3.5ch] text-end bg-transparent outline-none border-none ring-0 focus:outline-none focus:ring-0 focus:border-none";

  return (
    <div className="flex items-center gap-2 w-full rounded-xl px-5 py-3 box-border border border-mtm-light-gray hover:border-mtm-main-blue focus-within:border-mtm-main-blue">
      <input
        inputMode="numeric"
        pattern="\d*"
        size={4}
