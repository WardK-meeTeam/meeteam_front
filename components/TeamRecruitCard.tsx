...
export default function TeamRecruitCard ( {profileImg, name, temp, sideProjectCount, skills} : TeamCardProps) {
    return (
            ...
            <div className="flex flex-col px-5">
                ...
                <div className="flex gap-x-3">
                    ...
                    <div className="flex flex-col justify-center items-left gap-y-5">
                        {skills.map((skill, idx) => (
                            <div key={idx} className="w-[108px] h-[5px] rounded-[30px] bg-white">
                                <div 
